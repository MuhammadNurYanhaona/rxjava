...
public class Repository {
    ...
    public Future<Observable<ResponseBody>> makeFutureQuery() {
        ...
        final Callable<Observable<ResponseBody>> myNetworkCallable
                = new Callable<Observable<ResponseBody>>() {
            @Override
        ...
        final Future<Observable<ResponseBody>> futureObservable
                = new Future<Observable<ResponseBody>>() {
            @Override
            ...
            @Override
            public Observable<ResponseBody> get(long timeout, TimeUnit unit)
